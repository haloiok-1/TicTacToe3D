...
public class Field {
    ...
    public Player checkWin3D() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (panes[0].pane[0][i] == panes[1].pane[1][i] && panes[1].pane[1][i] == panes[2].pane[2][i] && panes[0].pane[0][i] != ' ') {
            ...
            if (panes[0].pane[2][i] == panes[1].pane[1][i] && panes[1].pane[1][i] == panes[2].pane[0][i] && panes[0].pane[2][i] != ' ') {
            ...
            //front left edge to back right edge
